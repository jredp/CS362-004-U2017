...
void baronEffect(struct gameState *state, int choice1, int currentPlayer)
{
...
int mineEffect(int j, struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos)
{
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
            i = mineEffect(j, state, currentPlayer, choice1, choice2, handPos);
            return i;
    ...
    case baron:
            baronEffect(state, choice1, currentPlayer);
            return 0;
